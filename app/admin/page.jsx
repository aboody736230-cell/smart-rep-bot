...
export default function AdminPage() {
  ...
  const addProductToStore = async () => {
    ...
    setNotice(`تم حفظ المنتج تلقائيًا داخل ${category} / ${branch}. اضغط «نشر داخل المتجر» عند الانتهاء.`);
  };
