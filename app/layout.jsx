...
export const metadata = {
  ...
  icons: { icon: [{ url: '/favicon.ico', type: 'image/x-icon' }, { url: '/icon.svg', type: 'image/svg+xml' }], shortcut: ['/favicon.ico'], apple: [{ url: '/icon.svg', type: 'image/svg+xml' }] },
...
const structuredData = {
  ...
  logo: 'https://kadel.online/favicon.ico',
