...
export const metadata = {
  ...
  icons: { icon: [{ url: '/favicon.ico', type: 'image/x-icon', sizes: '256x256' }, { url: '/icon.svg', type: 'image/svg+xml' }], shortcut: ['/favicon.ico'], apple: [{ url: '/icon.svg', type: 'image/svg+xml' }] },
...
const structuredData = {
  ...
  logo: 'https://www.kadel.online/icon.svg',
