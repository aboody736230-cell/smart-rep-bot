...
# إعدادات قاعدة بيانات Supabase (Session Pooler - IPv4)
...
VERIFY_TOKEN = "smart_rep_secret_2026"
WHATSAPP_TOKEN = ""
...
def receive_message():
    ...
    try:
        ...
        if not company_records:
            return jsonify({"status": "company_not_found"}), 200
        ...
        if products:
            ...
            reply_text = f"أهلاً بك في *{company_name}*!\nلم نجد نتائج مطابقة لـ \"{customer_text}\". اكتب اسم المنتج لعرض سعره وتوفره."
